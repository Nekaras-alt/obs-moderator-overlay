...
Переводы файлов из [`docs/`](../). Английские оригиналы остаются рядом.

| Документ | Описание |
|----------|----------|
| [USER.md](USER.md) | Руководство пользователя |
| [CONNECTOR.md](CONNECTOR.md) | Удалённый connector, relay, плагин |
| [CREDENTIALS.md](CREDENTIALS.md) | `.env`, Twitch, донаты, OBS WebSocket |
| [BUILD.md](BUILD.md) | Сборка на Windows |
